    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-bold text-gray-900 font-['Inter']">Subscription Packages</h1>
            <p className="text-xl text-gray-600 mt-2">Choose the perfect plan for your service needs</p>
          </div>
        </div>
        ...
        {packages.length === 0 ? (
          ...
          <>
            {/* Benefits Section */}
            <div className="mb-12 bg-white p-8 rounded-2xl shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center font-['Inter']">
        ...
        <div className="max-w-4xl mx-auto mt-16">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-semibold mb-2 text-lg">How does the payment process work?</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-semibold mb-2 text-lg">Can I upgrade or downgrade my package?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-semibold mb-2 text-lg">What happens if I don't use all my bookings?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-semibold mb-2 text-lg">Can I cancel my package anytime?</h3>
              <p className="text-gray-600">
